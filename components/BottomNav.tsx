...
import { Home, BarChart3, Brain, Star } from 'lucide-react';
import Link from 'next/link';

export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#0B0E11]/90 backdrop-blur-xl border-t border-[#2B3139] px-2 py-3 pb-6 flex items-center justify-around">
      ...
      <Link href="/ai" className="flex flex-col items-center gap-1 text-gray-500 hover:text-[#F3BA2F]">
        <Brain size={22} />
